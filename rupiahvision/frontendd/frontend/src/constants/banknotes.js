// Static reference data for the 7 supported denominations.
// Colors reflect the dominant printed ink of each real banknote (2022 emission series).
...
export const getBanknoteByLabel = (label) =>
  BANKNOTES.find((b) => b.label === label || b.classLabel === label)
